...
async function run(){
    ...
    let r1 = await check_availability(Clarenville, "Clarenville");
    let r2 = await check_availability(BayRoberts, "Bay Roberts");
    let r3 = await check_availability(MountPearl, "Mount Pearl");
    console.log(r1);
    console.log(r2);
    console.log(r3)
}
